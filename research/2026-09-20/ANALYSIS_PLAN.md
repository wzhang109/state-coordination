...
## Post-publication review additions

After the initial release and a discussion of rigor, additional diagnostics were specified and run: reproduce the WDI twenty-year coefficient; omit each of its 57 countries; compare ten- and twenty-year outcomes on identical rows and directly regress their within-country difference; add region controls; replace the linear transition-year term with decade indicators; and enumerate cohort differences. Results are in rigor_audit.json and code in rigor_audit.py. These checks are post-result exploration, not an amended primary outcome or independent confirmation.

The comparison of horizons does not support describing the twenty-year association as larger merely because its confidence interval is narrower. This interpretation correction leaves the original model tables and results intact.

A later chronology review found that the archived Korea note is printed April 2026 and already contains capacity-building and incumbent-entrenchment mechanisms. The author dates the project's initial hypothesis/proposal to late March. These are project-history clarifications; they do not backdate this September analysis plan or turn earlier design ideas into preregistered tests.
